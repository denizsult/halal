...
export type HealthListingRow = Record<string, unknown>;

export const healthListingsTableColumns: ColumnDef<HealthListingRow>[] = [
  {
    accessorKey: "name",
    header: "Name",
    enableSorting: true,
  ...
  getListingActionsColumn<HealthListingRow>(),
];
