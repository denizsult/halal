...
export type EventListingRow = Record<string, unknown>;

export const eventListingsTableColumns: ColumnDef<EventListingRow>[] = [
  {
    accessorKey: "name",
    header: "Event",
    enableSorting: true,
  ...
  getListingActionsColumn<EventListingRow>(),
];
