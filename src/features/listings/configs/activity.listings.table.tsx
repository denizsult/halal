...
export type ActivityListingRow = Record<string, unknown>;

export const activityListingsTableColumns: ColumnDef<ActivityListingRow>[] = [
  {
    accessorKey: "name",
    header: "Activity",
    enableSorting: true,
  ...
  getListingActionsColumn<ActivityListingRow>(),
];
