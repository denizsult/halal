...
export type TransferListingRow = Record<string, unknown>;

export const transferListingsTableColumns: ColumnDef<TransferListingRow>[] = [
  {
    accessorKey: "name",
    header: "Transfer",
    enableSorting: true,
  ...
  getListingActionsColumn<TransferListingRow>(),
];
